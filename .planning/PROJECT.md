...
- [ ] Builds and runs on modern Linux (Ubuntu 22.04+) with modern X11 libraries
- [ ] CMake build system with pkg-config for X11 dependency discovery
- [ ] Modern C++ (C++17) — std::vector, std::string, bool, RAII for X11 resources
